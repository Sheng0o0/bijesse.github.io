...
// before ... var eddie = {name: "Eddie Vedder", age: 49,};
...
var grungeAlbumsParsed = JSON.parse(grungeAlbumsJSON);
    ...
    //loops through array albums to print all data
for(var i=0; i < grungeAlbumsParsed.albums.length; i++){
console.log(grungeAlbumsParsed.albums[i].name);
};
// [ Step 5 ]
...
var eighties_music_JSON = JSON.stringify(eighties_music);
var eighties_music_parsed = JSON.parse(eighties_music_JSON);

console.log(eighties_music_parsed.artist);
